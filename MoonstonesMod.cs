...
{
    class MoonstonesMod : Mod
    {
        public static MoonstonesMod Instance { get; private set; }

        public static string GithubUserName { get { return "Beetrootmonkey"; } }
        public static string GithubProjectName { get { return "Moonstones"; } }
        ...
        public static string ConfigFileRelativePath
        {
            get { return "Mod Configs/Moonstones.json"; }
        }
        ...
        public static void ReloadConfigFromFile()
        {
            ...
            if (MoonstonesMod.Instance != null)
            {
                MoonstonesMod.Instance.Config.LoadFile();
            }
        }
        ...
        public override void Load()
        {
            ...
            if (!Main.dedServ)
            {
                ...
                SkyManager.Instance["MoonstonesMod:AnimatedColorize"] = this.Sky;
            }
        }

        private void LoadConfig()
        {
            var old_config = new JsonConfig<LunaticConfigData>("Moonstones 1.0.1.json", "", new LunaticConfigData());
            ...
            {
                ErrorLogger.Log("Moonstones updated to " + LunaticConfigData.ConfigVersion.ToString());
                this.Config.SaveFile();
            }
        }
